...
rerun = FALSE
  if(rerun){
    loo_mod.1 <- add_criterion(mod.1,  "kfold",  k = 10)
    loo_mod.2 <- add_criterion(mod.2,  "kfold",  k = 10)
    loo_mod.3 <- add_criterion(mod.3,  "kfold",  k = 10)
    loo_mod.4 <- add_criterion(mod.4,  "kfold",  k = 10)
    loo_mod.5 <- add_criterion(mod.5,  "kfold",  k = 10)
    loo_mod.6 <- add_criterion(mod.6,  "kfold",  k = 10)
    loo_mod.7 <- add_criterion(mod.7,  "kfold",  k = 10)
    loo_mod.8 <- add_criterion(mod.8,  "kfold",  k = 10)
    loo_mod.9 <- add_criterion(mod.9,  "kfold",  k = 10)
  }
#Compare
