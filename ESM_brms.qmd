...
waic_table_comp$id <- row.names(waic_table_comp)
  ...
  # loo - sensitivity analysis
   ...
   loo_table_comp <- loo_table_comp %>% select("Name Detail", "loo", "elpd_diff", "se_diff")
...
########################
  ...
  # loo
   ...
   loo_table_comp_cold <- data.frame(loo_compare(loo_table_cold))
    ...
    loo_table_comp_cold <- loo_table_comp_cold %>% select("Name Detail", "loo", "elpd_diff", "se_diff")
...
########################
  ...
  # loo
   ...
   loo_table_comp_hot <- data.frame(loo_compare(loo_table_hot))
    ...
    loo_table_comp_hot <- loo_table_comp_hot %>% select("Name Detail", "waic", "elpd_diff", "se_diff")
