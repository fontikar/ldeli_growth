...
#Read in models
  mod.1 <- readRDS("./output/rds/brm_1")
  mod.2 <- readRDS("./output/rds/brm_2")
  mod.3 <- readRDS("./output/rds/brm_3")
  mod.4 <- readRDS("./output/rds/brm_4")
  mod.5 <- readRDS("./output/rds/brm_5")
  mod.6 <- readRDS("./output/rds/brm_6")
  mod.7 <- readRDS("./output/rds/brm_7")
  mod.8 <- readRDS("./output/rds/brm_8") # Models already fit and renames to 8 and 9
  mod.9 <- readRDS("./output/rds/brm_9")
...
rerun = FALSE
  if(rerun){
    loo_mod.1 <- add_criterion(mod.1, "loo", moment_match = TRUE)
    loo_mod.2 <- add_criterion(mod.2, "loo", moment_match = TRUE)
    loo_mod.3 <- add_criterion(mod.3, "loo", moment_match = TRUE)
    loo_mod.4 <- add_criterion(mod.4, "loo", moment_match = TRUE)
    loo_mod.5 <- add_criterion(mod.5, "loo", moment_match = TRUE)
    loo_mod.6 <- add_criterion(mod.6, "loo", moment_match = TRUE)
    loo_mod.7 <- add_criterion(mod.7, "loo", moment_match = TRUE)
    loo_mod.8 <- add_criterion(mod.8, "loo", moment_match = TRUE)
    loo_mod.9 <- add_criterion(mod.9, "loo", moment_match = TRUE)
  }
#Compare
  waic_mods <- loo_compare(w_mod.1, w_mod.2, w_mod.3, w_mod.4, w_mod.5, w_mod.6, w_mod.7, w_mod.8, w_mod.9)
