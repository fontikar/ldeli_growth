...
cv
ggsave(cv, filename = "output/figures/figS1.pdf", width = 14.679012, height = 5.703704, units = "in")
...
cv2 
ggsave(cv2, filename = "output/figures/figS2.pdf", width = 14.679012, height = 5.703704, units = "in")
```
