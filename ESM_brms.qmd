...
```{r}
#CV of h2 and m2
hot_CV_h2 <- lapply(seq(0, 450, 30), function(x) get_CV_X2(model = brm_12_hot_het_fixed1, x = x, group_var = "h2")) %>% bind_rows()
hot_CV_m2 <- lapply(seq(0, 450, 30), function(x) get_CV_X2(model = brm_12_hot_het_fixed1, x = x, group_var = "m2")) %>% bind_rows()
