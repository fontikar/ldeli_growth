...
#Residuals
  hot_e_int <- exp(posterior_samples(hot_brm_5.5, "b_sigma_I"))^2 %>% posterior_summary() %>% signif(digits = 3)
hot_e_slope <- posterior_samples(hot_brm_5.5, "b_sigma_z") %>% posterior_summary() %>% signif(digits = 3)
