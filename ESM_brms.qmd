...
# Add loos for comparison
    ...
    loo_mod.2_cold <- add_criterion(mod.2_cold, "loo", moment_match = TRUE)
    loo_mod.3_cold <- add_criterion(mod.3_cold, "loo", moment_match = TRUE)
    loo_mod.4_cold <- add_criterion(mod.4_cold, "loo", moment_match = TRUE)
    loo_mod.5_cold <- add_criterion(mod.5_cold, "loo", moment_match = TRUE)
    loo_mod.6_cold <- add_criterion(mod.6_cold, "loo", moment_match = TRUE)
    loo_mod.7_cold <- add_criterion(mod.7_cold, "loo", moment_match = TRUE)
    loo_mod.8_cold <- add_criterion(mod.8_cold, "loo", moment_match = TRUE)
    loo_mod.9_cold <- add_criterion(mod.9_cold, "loo", moment_match = TRUE)
