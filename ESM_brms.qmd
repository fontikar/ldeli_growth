...
# Add loos for comparison
    loo_mod.1 <- add_criterion(mod.1, "loo", moment_match = TRUE, reloo = TRUE)
    loo_mod.2 <- add_criterion(mod.2, "loo", moment_match = TRUE, reloo = TRUE)
    loo_mod.3 <- add_criterion(mod.3, "loo", moment_match = TRUE, reloo = TRUE)
    loo_mod.4 <- add_criterion(mod.4, "loo", moment_match = TRUE, reloo = TRUE)
    loo_mod.5 <- add_criterion(mod.5, "loo", moment_match = TRUE, reloo = TRUE)
    loo_mod.6 <- add_criterion(mod.6, "loo", moment_match = TRUE, reloo = TRUE)
    loo_mod.7 <- add_criterion(mod.7, "loo", moment_match = TRUE, reloo = TRUE)
    loo_mod.8 <- add_criterion(mod.8, "loo", moment_match = TRUE, reloo = TRUE)
    loo_mod.9 <- add_criterion(mod.9, "loo", moment_match = TRUE, reloo = TRUE)

#Compare
loo_compare(w_mod.1, w_mod.2, w_mod.3, w_mod.4, w_mod.5, w_mod.6, w_mod.7, w_mod.8, w_mod.9)

loo_compare(loo_mod.1, loo_mod.2, loo_mod.3, loo_mod.4, loo_mod.5, loo_mod.6, loo_mod.7, loo_mod.8, loo_mod.9)
