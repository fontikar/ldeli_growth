...
brms_hot_Vg <- lapply(z_days, function(x) brms_Vcomp(model = hot_brm_5.5, x = x, group_var = "F1_Genotype", data = data_DA)) %>% bind_rows()
brms_hot_Vm <- lapply(z_days, function(x) brms_Vcomp(model = hot_brm_5.5, x = x, group_var = "dam_id", data = data_DA)) %>% bind_rows()
brms_hot_Ve <- lapply(z_days, function(x) brms_Vcomp(model = hot_brm_5.5, x = x, group_var = "sigma", data = data_DA)) %>% bind_rows()
...
brms_cold_Vg <- lapply(z_days, function(x) brms_Vcomp(model = cold_brm_5.5, x = x, group_var = "F1_Genotype", data = data_DA)) %>% bind_rows()
brms_cold_Vm <- lapply(z_days, function(x) brms_Vcomp(model = cold_brm_5.5, x = x, group_var = "dam_id", data = data_DA)) %>% bind_rows()
brms_cold_Ve <- lapply(z_days, function(x) brms_Vcomp(model = cold_brm_5.5, x = x, group_var = "sigma", data = data_DA)) %>% bind_rows()
...
brms_hot_h2 <- lapply(z_days, function(x) brms_h2(model = hot_brm_5.5, z_age = x, G = "F1_Genotype", M = "dam_id", data = data_DA)) %>% bind_rows()
brms_hot_m2 <- lapply(z_days, function(x) brms_m2(model = hot_brm_5.5, z_age = x, G = "F1_Genotype", M = "dam_id", data = data_DA)) %>% bind_rows()
...
brms_cold_h2 <- lapply(z_days, function(x) brms_h2(model = cold_brm_5.5, z_age = x, G = "F1_Genotype", M = "dam_id", data = data_DA)) %>% bind_rows()
brms_cold_m2 <- lapply(z_days, function(x) brms_m2(model = cold_brm_5.5, z_age = x, G = "F1_Genotype", M = "dam_id", data = data_DA)) %>% bind_rows()
