...
pacman::p_load(dplyr, magrittr, ggplot2, patchwork, lubridate, stringr, tidyr, MCMCglmm, bookdown, pander, brms, janitor, purrr, tidybayes, stringr, latex2exp, tidybayes, bayestestR, kinship2, xlsx)
...
flextable::flextable(tab2)  %>% flextable::width(j = 1, width = 5)  %>% flextable::compose(j = 1, value = flextable::as_paragraph(flextable::as_equation("model", width = 3)))
```
