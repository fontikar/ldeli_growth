...
# What is the R2 for the top model?
  r2_fixed_main <- bayes_R2(brm_12_het_fixed4)
...
# Cold mass at hatch. Convert back from log (grams) to grams.
  cold_intercept <- brm_12_het_fixed_post[,"b_Intercept"] %>% exp()
  posterior_summary(cold_intercept)
  mean(cold_intercept)

# Hot mass at hatch. Convert back from log (grams) to grams.
  hot_intercept <- (brm_12_het_fixed_post[,"b_Intercept"] + brm_12_het_fixed_post[,"b_treatment29"]) %>% exp()
