...
#The model
brm_12_het_mod <- 
  bf(lnMass ~ z_days_since_hatch + treatment * z_days_since_hatch_I2 + 
...
brm_12_het_fixed3 <- brm(brm_12_het_mod,
               family = gaussian(),
               prior = priors,
...
saveRDS(brm_12_het_fixed3, "output/rds/brm_12_het_fixed3")
