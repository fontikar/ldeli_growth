...
mods_hot <- bf(lnMass ~ z_days_since_hatch + z_days_since_hatch_I2 +
...
brm_12_hot_het_fixed1 <- brm(mods_hot,
               family = gaussian(),
               prior = priors,
...
saveRDS(brm_12_hot_het_fixed1, "output/rds/brm_12_hot_het_fixed1")
